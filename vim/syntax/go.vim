...
if get(g:, 'go_fold_enable_comment', 0)
...
if get(g:, 'go_highlight_format_strings', 1)
...
if get(g:, 'go_fold_enable_block', 0)
...
if get(g:, 'go_fold_enable_import', 0)
...
if get(g:, 'go_fold_enable_varaconst', 0)
...
if get(g:, 'go_highlight_functions', 0) || get(g:, 'go_highlight_function_parameters', get(g:, 'go_highlight_function_arguments', 0))
  ...
  if get(g:, 'go_highlight_function_parameters', get(g:, 'go_highlight_function_arguments', 0))
